...
(function (ls) {
    ...
    function timeScale() {
        return 60 / ls.EventSheetDecoder.tickInterval;
    }
    ...
    ls.acos = acos;
    // export function angle(x1:any,x2:any,x3:any):number {
    //     x1 = eval_e(x1);
    //     x2 = eval_e(x2);
    //     x3 = eval_e(x3);
    // }
    // export function anglediff(angle1:any,angle2:any):number {
    //     angle1 = eval_e(angle1);
    //     angle2 = eval_e(angle2);
    // }
    // export function anglelerp(a:any,b:any,x:any):number {
    // }
    // export function anglerotate(start:any,end:any,step:any):number {
    // }
    /**返回数value的反正弦值 */
    function asin(value) {
        value = eval_e(value);
