                        ...
                        switch (propertyValueType) {
                            ...
                            case "string":
                                ...
                                if (propertyName == "collisionData") {
                                    this.decodeCollision(instance, properties[propertyName]);
                                }
                                break;
                            case "boolean":
                            ...
                            case 0:
                                ...
                                if (isExistUnderline != -1) {
                                    ...
                                    for (var i = 0; i < underlineSplit.length; i++) {
                                        ...
                                        inst.collisionVectorData[i] = polyData;
                                    }
                                }
                                else {
                                    ...
                                    inst.collisionVectorData[0] = polyData;
                                }
                                break;
                            case 1:
                                ...
                                inst.collisionVectorData = circle;
                                break;
                            case 2:
                                var dotData = spData[1].split("|"); //x，y;
                                inst.collisionVectorData = new ls.Vector2D(+dotData[0], +dotData[1]);
                                break;
                        }
                    }
                }
